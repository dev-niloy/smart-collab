...
## Last Completed Task
t14 — theme + a11y sweep complete. 0 hex literals + intentional status palette + aria-label coverage verified + lint 0 errors. Frontend 415/415.

## Next Task
t15 — full suite green + local manual smoke checklist
