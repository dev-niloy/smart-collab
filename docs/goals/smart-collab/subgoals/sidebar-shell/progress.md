...
## Last Completed Task
t13 — Mobile drawer: useMediaQuery hook + MobileDrawer (shadcn Sheet wrap); ShellLayout branches on MOBILE_MEDIA_QUERY into mobile-stacked vs desktop side-by-side; 7 new tests; frontend 415/415

## Next Task
t14 — theme + a11y parity sweep (axe-core CLI + grep for hex literals)
